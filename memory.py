...
ARL_FAM = [ INTEL_ARROWLAKE, INTEL_ARROWLAKE_H, INTEL_ARROWLAKE_U ]
...
def get_mchbar_info(info, controller, channel):
    ...
    if True:
        ...
        if proc_model_id in ADL_FAM:   # Self-Refresh Timing Parameters
        ...
        if proc_model_id in ADL_FAM: # ref: ICÈ_TÈA_BIOS  (leaked BIOS sources)  # file "MrcMcRegisterStructAdlExxx.h"
...
def get_mem_ctrl(ctrl_num):
    ...
    if proc_model_id in ADL_FAM or proc_model_id in ARL_FAM:
        MC_REGS_SIZE = 0x800
